package Java数据结构和算法.数据结构和算法__C语言.exam.栈.逆波兰计算器;
...
public class PolandNotation {
    ...
    public static List<String> parseSuffixExpreesionList(List<String> ls) throws Exception {
        //定义两个栈
        ...
        for (String item : ls) {
            ...
            if (item.matches("\\d+")) {
                ...
                while (!s1.peek().equals("(")) {//peek方法是返回栈顶的元素但不移除它。
                    s2.add(s1.pop());
                }
