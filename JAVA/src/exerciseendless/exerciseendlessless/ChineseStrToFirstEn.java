 ...
 * 注：只支持GB2312字符集中的汉字
 */
public class ChineseStrToFirstEn {
            ...
            if (li_SecPosCode > 1600 && li_SecPosCode < 5590) {
                for (int i = 0; i < 23; i++) {
                    if (li_SecPosCode >= li_SecPosValue[i]
                        ...
                        chinese = isUpper?lc_FirstLetter[i].toUpperCase():lc_FirstLetter[i];
                        break;
                    }
                }
    ...
    public static void main(String[] args) {
        String aa = ChineseStrToFirstEn.getAllFirstLetter("小泽玛利亚", true);
