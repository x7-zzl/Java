...
public class WuZiQi {
    ...
    JButton blackBtn = new JButton("黑棋");
    JButton deleteBtn = new JButton("悔棋");
    ...
    public void init() throws Exception {
       ...
       whiteBtn.addActionListener(e->{
        ...
        //初始化图片
        table = ImageIO.read(new File("D:\\IntelliJ IDEA 2021.1.2\\代码\\JAVA\\src\\图形用户界面\\五子棋\\awt\\board.jpg"));
        white = ImageIO.read(new File("D:\\IntelliJ IDEA 2021.1.2\\代码\\JAVA\\src\\图形用户界面\\五子棋\\awt\\white.gif"));
        black = ImageIO.read(new File("D:\\IntelliJ IDEA 2021.1.2\\代码\\JAVA\\src\\图形用户界面\\五子棋\\awt\\black.gif"));
        selected = ImageIO.read(new File("D:\\IntelliJ IDEA 2021.1.2\\代码\\JAVA\\src\\图形用户界面\\五子棋\\awt\\selected.gif"));
